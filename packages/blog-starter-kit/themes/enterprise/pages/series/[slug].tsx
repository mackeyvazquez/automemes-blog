				...
				<Container className="flex flex-col items-stretch gap-10 px-5 pb-10 pt-20">
					...
					>
						<div className="col-span-full flex flex-col gap-1 md:col-span-2 lg:col-span-3">
							<p className="font-bold uppercase text-slate-500 dark:text-gray-400">Series</p>
							<h1 className="text-4xl font-bold text-slate-900 dark:text-gray-50">{series.name}</h1>
							<div
