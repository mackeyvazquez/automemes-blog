				...
				<Container className="flex flex-col items-stretch gap-10 px-5 pb-10">
					...
					{allPosts.length === 0 && (
						<div className="grid grid-cols-1 py-20 lg:grid-cols-3">
							<div className="col-span-1 flex flex-col items-center gap-5 text-center text-slate-700 lg:col-start-2 dark:text-gray-400">
								<div className="w-20">
					...
					{allPosts.length > 0 && (
						<div className="dark:bg-background grid grid-cols-4 rounded-lg bg-slate-100 px-2 py-5 md:py-10">
							<div className="col-span-full md:col-span-2 md:col-start-2">
								<h2 className="text-primary-900 mb-5 text-center text-lg font-semibold dark:text-slate-100">
									Get daily viral meme templates and access a library of strategies driving
									meme-powered growth for businesses!
								</h2>
								<SubscribeForm />
							</div>
						</div>
