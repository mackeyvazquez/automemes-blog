...
export const SocialLinks = ({ isSidebar }: { isSidebar?: boolean }) => {
	...
	return (
		<>
			<div
				className={`col-span-1 flex flex-row flex-wrap gap-1 text-slate-600 md:flex-nowrap dark:text-gray-300 ${
					...
					<>
						{publication.links?.twitter && (
							<a
								...
								className="flex flex-row items-center justify-center rounded-full border border-slate-200 p-2 hover:bg-slate-100 dark:border-gray-800 dark:hover:bg-gray-600"
							>
